...
if (isset($_POST['id_order']) && isset($_POST['tanggal_pembayaran']) && isset($_POST['bukti_pembayaran_path'])) {
  $idOrder = $_POST['id_order'];
  $tanggalPembayaran = $_POST['tanggal_pembayaran'];
  $buktiPembayaranPath = $_POST['bukti_pembayaran_path'];

  $query = "INSERT INTO bukti_pembayaran (id_order, tanggal_pembayaran, bukti_pembayaran_path) VALUES ('$idOrder', '$tanggalPembayaran', '$buktiPembayaranPath')";
...
if (isset($_POST['edit_id_order']) && isset($_POST['edit_tanggal_pembayaran']) && isset($_POST['edit_bukti_pembayaran_path'])) {
  $idOrder = $_POST['edit_id_order'];
  $tanggalPembayaran = $_POST['edit_tanggal_pembayaran'];
  $buktiPembayaranPath = $_POST['edit_bukti_pembayaran_path'];

  $query = "UPDATE bukti_pembayaran SET tanggal_pembayaran='$tanggalPembayaran', bukti_pembayaran_path='$buktiPembayaranPath' WHERE id_order='$idOrder'";
  $result = mysqli_query($conn, $query);
...
if (isset($_GET['id_order'])) {
  ...
  $query = "DELETE FROM bukti_pembayaran WHERE id_order='$idOrder'";
  $result = mysqli_query($conn, $query);
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <form method="POST" enctype="multipart/form-data"> <!-- Perhatikan penambahan enctype -->
                              <div class="mb-3">
