...
if (isset($_POST['id_persediaan']) && isset($_POST['nama_persediaan']) && isset($_POST['quantity']) && isset($_POST['saldo'])) {
  $idPersediaan = $_POST['id_persediaan'];
  $namaPersediaan = $_POST['nama_persediaan'];
  $quantity = $_POST['quantity'];
  $saldo = $_POST['saldo'];

  $query = "INSERT INTO data_persediaan (id_persediaan, nama_persediaan, quantity, saldo) VALUES ('$idPersediaan', '$namaPersediaan', '$quantity', '$saldo')";
...
if (isset($_POST['edit_id_persediaan']) && isset($_POST['edit_nama_persediaan']) && isset($_POST['edit_quantity']) && isset($_POST['edit_saldo'])) {
  $idPersediaan = $_POST['edit_id_persediaan'];
  $namaPersediaan = $_POST['edit_nama_persediaan'];
  $quantity = $_POST['edit_quantity'];
  $saldo = $_POST['edit_saldo'];

  $query = "UPDATE data_persediaan SET nama_persediaan='$namaPersediaan', quantity='$quantity', saldo='$saldo' WHERE id_persediaan='$idPersediaan'";
  $result = mysqli_query($conn, $query);
...
if (isset($_GET['id_persediaan'])) {
  ...
  $query = "DELETE FROM data_persediaan WHERE id_persediaan='$idPersediaan'";
  $result = mysqli_query($conn, $query);
...
$query_select = "SELECT * FROM data_persediaan";
...
<head>
  ...
  <title>SIMITRA - Persediaan</title> <!-- EDIT NAMA -->
...
<body id="page-top">
                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <?php
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<button type='button' class='btn btn-success btn-sm' style='width: 30px; height: 30px;' data-bs-toggle='modal' data-bs-target='#editModal' onclick='openEditModal(\"".$data['id_persediaan']."\", \"".$data['nama_persediaan']."\", \"".$data['quantity']."\", \"".$data['saldo']."\")'><i class='fas fa-edit'></i></button>";
                        echo "<button type='button' class='btn btn-danger btn-sm' style='width: 30px; height: 30px;' onclick='openDeleteModal(\"".$data['id_persediaan']."\")'><i class='fas fa-trash'></i></button>";
                        echo "</td>";
                        echo "</tr>"; 
                    }
                  ?>
  ...
  <script>
    ...
    function openDeleteModal(idPersediaan) {
