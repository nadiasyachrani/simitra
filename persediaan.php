                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <?php
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='generate_pdf.php?id_persediaan=".htmlspecialchars($data['id_persediaan'])."' class='btn btn-primary btn-sm' target='_blank' role='button'><i class='fas fa-print'></i></a>";
                        echo "</td>";
                        echo "</tr>"; 
                    }
                  ?>
