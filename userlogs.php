...
if (isset($_GET['tanggal_login']) && isset($_GET['posisi']) && isset($_GET['username'])) {
  $tanggalLogin = $_GET['tanggal_login'];
  $posisi = $_GET['posisi'];
  $username = $_GET['username'];

  $query = "DELETE FROM data_user_logs WHERE tanggal_login='$tanggalLogin' AND posisi='$posisi' AND username='$username'";
  $result = mysqli_query($conn, $query);
...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
              ...
              <div class="modal-dialog">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="addModalLabel">Tambah Data User Logs</h5>
                      ...
                      <div class="modal-body">
                          <form method="POST">
                              <div class="mb-3">
                                  ...
                                  <input type="date" class="form-control" id="tanggal_login" name="tanggal_login" required>
                              </div>
                              <div class="mb-3">
          ...
          <!-- Modal Edit Data User Logs -->
          <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                  <div class="modal-content">
                      <div class="modal-header">
                          <h5 class="modal-title" id="editModalLabel">Edit Data User Logs</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                          <form method="POST">
                              <div class="mb-3">
                                  <label for="edit_tanggal_login" class="form-label">Tanggal Login:</label>
                                  <input type="date" class="form-control" id="edit_tanggal_login" name="edit_tanggal_login" required>
                              </div>
                              <div class="mb-3">
                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <?php
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<button type='button' class='btn btn-success btn-sm' data-bs-toggle='modal' data-bs-target='#editModal' onclick='openEditModal(\"".$data['tanggal_login']."\", \"".$data['posisi']."\", \"".$data['username']."\", \"".$data['nama_lengkap']."\", \"".$data['keterangan']."\")'><i class='fas fa-edit'></i></button>";
                        echo "<button type='button' class='btn btn-danger btn-sm' onclick='deleteData(\"".$data['tanggal_login']."\")'><i class='fas fa-trash'></i></button>";
                        echo "<a href='generate_pdf.php?id_persediaan=".htmlspecialchars($data['tanggal_login'])."' class='btn btn-primary btn-sm' target='_blank' role='button'><i class='fas fa-print'></i></a>";
                        echo "</td>";
                        echo "</tr>"; 
                    }
                  ?>
  ...
  <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
  <script>
    function openEditModal(tanggalLogin, posisi, username, namaLengkap) {
      document.getElementById("edit_tanggal_login").value = idPersediaan;
    ...
    function deleteData(tanggalLogin) {
      if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
        window.location.href = "?tanggal_login=" + tanggalLogin;
      }
    }
  </script>
  <!-- AKHIR EDIT SESUAIKAN TABEL DATABASE -->
