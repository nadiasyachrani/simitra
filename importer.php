...
if (isset($_POST['id_importer']) && isset($_POST['nama_importer']) && isset($_POST['alamat_importer']) && isset($_POST['telp_importer']) && isset($_POST['fax'])&& isset($_POST['usci'])&& isset($_POST['pic'])) {
    ...
    $query = "INSERT INTO data_importer (id_importer, nama_importer, alamat_importer, telp_importer, fax,usci,pic) VALUES ('$idimporter', '$namaimporter', '$alamatimporter', '$telpimporter', '$fax','$usci','$pic')";
...
if (isset($_POST['edit_id_importer']) && isset($_POST['edit_nama_importer']) && isset($_POST['edit_alamat_importer']) && isset($_POST['edit_telp_importer']) && isset($_POST['edit_fax'])&& isset($_POST['edit_usci'])&& isset($_POST['edit_pic'])) {
    ...
    $query = "UPDATE data_importer SET nama_importer='$namaimporter', alamat_importer='$alamatimporter', telp_importer='$telpimporter', fax='$fax', usci='$usci', pic='$pic' WHERE id_importer='$idimporter'";
    $result = mysqli_query($conn, $query);
...
if (isset($_GET['id_importer'])) {
    $idimporter = $_GET['id_importer'];

    $query = "DELETE FROM data_importer WHERE id_importer='$idimporter'";
    $result = mysqli_query($conn, $query);
...
<body id="page-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">DATA IMPORTER</li> <!-- EDIT NAMA -->
            </ol>
          </div>
          <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
          <!-- Modal Tambah Data -->
                      ...
                      <div class="modal-body">
                          <form method="POST">
                              ...
                              <div class="mb-3">
                                  ...
                                  <input type="number" class="form-control" id="telp_importer" name="telp_importer" required>
                              </div>
                              <div class="mb-3">
                      ...
                      <div class="modal-body">
                          <form method="POST">
                              ...
                              <div class="mb-3">
                                  ...
                                  <input type="number" class="form-control" id="edit_nama_importer" name="edit_nama_importer" required>
                              </div>
                              <div class="mb-3">
                                  <label for="edit_alamat_importer" class="form-label">Alamat Importer:</label>
                                  <input type="number" class="form-control" id="edit_alamat_importer" name="edit_alamat_importer" required>
                              </div>
                              <div class="mb-3">
                                  <label for="edit_telp_importer" class="form-label">Telepon Importer:</label>
                                  <input type="number" class="form-control" id="edit_telp_importer" name="edit_telp_importer" required>
                              </div>
                              <div class="mb-3">
                                  <label for="edit_fax" class="form-label">FAX:</label>
                                  <input type="number" class="form-control" id="edit_fax" name="edit_fax" required>
                              </div>
                              <div class="mb-3">
                  ...
                  <tbody>
                    <?php
                      ...
                      while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<button type='button' class='btn btn-success btn-sm' data-bs-toggle='modal' data-bs-target='#editModal' onclick='openEditModal(\"".$data['id_importer']."\", \"".$data['nama_importer']."\", \"".$data['alamat_importer']."\", \"".$data['telp_importer']."\", \"".$data['fax']."\")'><i class='fas fa-edit'></i></button>";
                        echo "<button type='button' class='btn btn-danger btn-sm' onclick='deleteData(\"".$data['id_importer']."\")'><i class='fas fa-trash'></i></button>";
                        echo "<a href='generate_pdf.php?id_importer=".htmlspecialchars($data['id_importer'])."' class='btn btn-primary btn-sm' target='_blank' role='button'><i class='fas fa-print'></i></a>";
                        echo "</td>";
                        echo "</tr>"; 
                        }
                    ?>
  ...
  <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
  <script>
    function openEditModal(idimporter, namaimporter, alamatimporter, telpimporter, fax) {
