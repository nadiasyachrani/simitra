...
if (isset($_POST['id_pegawai']) && isset($_POST['nama_pegawai']) && isset($_POST['alamat_pegawai']) && isset($_POST['telp_pegawai']) && isset($_POST['posisi'])&& isset($_POST['noreg_fumigasi'])&& isset($_POST['gaji_pokok'])) {
    ...
    $alamatimporter = $_POST['alamat_pegawai'];
...
if (isset($_POST['edit_id_pegawai']) && isset($_POST['edit_nama_pegawai']) && isset($_POST['edit_alamat_pegawai']) && isset($_POST['edit_telp_pegawai']) && isset($_POST['edit_posisi'])&& isset($_POST['edit_noreg_fumigasi'])&& isset($_POST['edit_gaji_pokok'])) {
    ...
    $alamatimporter = $_POST['edit_alamat_pegawai'];
    $telppegawai = $_POST['edit_telp_pegawai'];
    $posisi = $_POST['edit_posisi'];
    $noreg_fumigasi = $_POST['edit_noreg_fumigasi'];
    $gaji_pokok = $_POST['edit_gaji_pokok'];

    $query = "UPDATE data_importer SET nama_pegawai='$namapegawai', alamat_pegawai='$alamatimporter', telp_pegawai='$telppegawai', posisi='$posisi', noreg_fumigasi='$noregfumigasi', gaji_pokok='$gajipokok' WHERE id_pegawai='$idpegawai'";
    $result = mysqli_query($conn, $query);
...
if (isset($_GET['id_pegawai'])) {
    ...
    $query = "DELETE FROM data_importer WHERE id_pegawai='$idpegawai'";
    $result = mysqli_query($conn, $query);
...
// Mengambil data dari tabel data_importer
$query_select = "SELECT * FROM data_importer";
...
<head>
  ...
  <title>SIMITRA - DATA HARGA</title> <!-- EDIT NAMA -->
...
<body id="page-top">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">DATA PEGAWAI</li> <!-- EDIT NAMA -->
            </ol>
          </div>
          <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
          <!-- Modal Tambah Data -->
                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <form method="POST">
                              ...
                              <div class="mb-3">
                                  <label for="alamat_pegawai" class="form-label">Alamat Importer:</label>
                              ...
                              <div class="mb-3">
                                  ...
                                  <input type="number" class="form-control" id="telp_pegawai" name="telp_pegawai" required>
                              </div>
                              <div class="mb-3">
                              ...
                              <div class="mb-3">
                                  <label for="noreg_fumigasi" class="form-label">No Reg Fumigasi:</label>
                                  <input type="text" class="form-control" id="noreg_fumigasi" name="noreg_fumigasi" required>
                              </div>
                              <div class="mb-3">
                      ...
                      <div class="modal-body">
                          <form method="POST">
                              ...
                              <div class="mb-3">
                                  ...
                                  <input type="number" class="form-control" id="edit_nama_pegawai" name="edit_nama_pegawai" required>
                              </div>
                              <div class="mb-3">
                                  <label for="edit_alamat_pegawai" class="form-label">Alamat Importer:</label>
                                  <input type="number" class="form-control" id="edit_alamat_pegawai" name="edit_alamat_pegawai" required>
                              </div>
                              <div class="mb-3">
                                  <label for="edit_telp_pegawai" class="form-label">Telepon Pegawai:</label>
                                  <input type="number" class="form-control" id="edit_telp_pegawai" name="edit_telp_pegawai" required>
                              </div>
                              <div class="mb-3">
                                  <label for="edit_posisi" class="form-label">Posisi:</label>
                                  <input type="number" class="form-control" id="edit_posisi" name="edit_posisi" required>
                              </div>
                              <div class="mb-3">
                                  <label for="edit_noreg_fumigasi" class="form-label">No Reg Fumigasi:</label>
                                  <input type="text" class="form-control" id="edit_noreg_fumigasi" name="edit_noreg_fumigasi" required>
                              </div>
                              <div class="mb-3">
                  ...
                  <tbody>
                    <?php
                      ...
                      while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<button type='button' class='btn btn-success btn-sm' data-bs-toggle='modal' data-bs-target='#editModal' onclick='openEditModal(\"".$data['id_pegawai']."\", \"".$data['nama_pegawai']."\", \"".$data['alamat_pegawai']."\", \"".$data['telp_pegawai']."\", \"".$data['posisi']."\")'><i class='fas fa-edit'></i></button>";
                        echo "<button type='button' class='btn btn-danger btn-sm' onclick='deleteData(\"".$data['id_pegawai']."\")'><i class='fas fa-trash'></i></button>";
                        echo "<a href='generate_pdf.php?id_pegawai=".htmlspecialchars($data['id_pegawai'])."' class='btn btn-primary btn-sm' target='_blank' role='button'><i class='fas fa-print'></i></a>";
                        echo "</td>";
                        echo "</tr>"; 
                        }
                    ?>
  ...
  <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
  <script>
    function openEditModal(idpegawai, namapegawai, alamatimporter, telppegawai, posisi) {
      document.getElementById("edit_id_pegawai").value = idpegawai;
      document.getElementById("edit_nama_pegawai").value = namapegawai;
      document.getElementById("edit_alamat_pegawai").value = alamatimporter;
