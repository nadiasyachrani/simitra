...
if (isset($_POST['id_rekap_penjualan']) && isset($_POST['id_invoice']) && isset($_POST['tanggal_invoice']) && isset($_POST['volume']) && isset($_POST['quantity']) && isset($_POST['total_penjualan'])) {
  ...
  $query = "INSERT INTO rekap_penjualan (id_rekap_penjualan, id_invoice, tanggal_invoice, volume, quantity, total_penjualan) VALUES ('$idRekapPenjualan', '$idInvoice','$tanggalInvoice', '$volume', '$quantity', '$totalPenjualan')";
...
if (isset($_POST['edit_id_rekap_penjualan']) && isset($_POST['edit_id_invoice']) && isset($_POST['edit_tanggal_invoice']) && isset($_POST['edit_volume']) && isset($_POST['edit_quantity']) && isset($_POST['edit_total_penjualan'])) {
  ...
  $query = "UPDATE rekap_penjualan SET id_invoice='$idInvoice', tanggal_invoice='$tanggalInvoice',volume='$volume', quantity='$quantity', total_penjualan='$totalPenjualan' WHERE id_rekap_penjualan='$idRekapPenjualan'";
  $result = mysqli_query($conn, $query);
...
if (isset($_GET['id_rekap_penjualan'])) {
  $idRekapPenjualan = $_GET['id_rekap_penjualan'];

  $query = "DELETE FROM rekap_penjualan WHERE id_rekap_penjualan='$idRekapPenjualan'";
  $result = mysqli_query($conn, $query);
...
// Mengambil data dari tabel rekap_penjualan
$query_select = "SELECT * FROM rekap_penjualan";
...
<body id="page-top">
                      ...
                      <div class="modal-body">
                          <form method="POST">
                              <div class="mb-3">
                                  ...
                                  <input type="text" class="form-control" id="edit_id_rekap_penjualan" name="edit_id_rekap_penjualan" readonly required>
                              </div>
                              <div class="mb-3">
                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <?php
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>";
                        echo "<button type='button' class='btn btn-success btn-sm' style='width: 30px; height: 30px;' data-bs-toggle='modal' data-bs-target='#editModal' onclick='openEditModal(\"".$data['id_rekap_penjualan']."\", \"".$data['id_invoice']."\",\"".$data['tanggal_invoice']."\", \"".$data['volume']."\", \"".$data['quantity']."\", \"".$data['total_penjualan']."\")'><i class='fas fa-edit'></i></button>"; // Menggunakan nama kolom yang sesuai
                        echo "<button type='button' class='btn btn-danger btn-sm' style='width: 30px; height: 30px;' onclick='openDeleteModal(\"".$data['id_rekap_penjualan']."\")'><i class='fas fa-trash'></i></button>"; // Menggunakan nama kolom yang sesuai
                        echo "</td>";
                        echo "</tr>"; 
                    }
                  ?>
  ...
  <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
  <script>
    function openEditModal(idRekapPenjualan, idInvoice,tanggalInvoice, volume, quantity, totalPenjualan) {
    ...
    function openDeleteModal(idRekapPenjualan) {
