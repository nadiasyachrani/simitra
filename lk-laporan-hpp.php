        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Laporan Harga Pokok Penjualan</li> <!-- EDIT NAMA -->
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div class="btn-group ml-auto" role="group" aria-label="Basic mixed styles example">
                  ...
                  <div>
                    <button type="button" class="btn btn-sm btn-primary" style='width: 70px; height: 30px;' data-bs-toggle="modal" data-bs-target="#addModal">
                      Posting
                    </button>
                  </div>
                  ...
                  <tbody>
                      <?php
                          ...
                          while ($data = mysqli_fetch_assoc($result)) {
                              echo "<tr>";
                              echo "<td>Harga Pokok Penjualan</span></td>"; 
