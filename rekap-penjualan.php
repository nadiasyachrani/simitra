...
if (isset($_POST['id_rekap_penjualan']) && isset($_POST['id_invoice']) && isset($_POST['volume']) && isset($_POST['quantity']) && isset($_POST['total_penjualan'])) {
  ...
  $query = "INSERT INTO rekap_penjualan (id_rekap_penjualan, id_invoice, volume, quantity, total_penjualan) VALUES ('$idRekapPenjualan', '$idInvoice', '$volume', '$quantity', '$totalPenjualan')";
...
if (isset($_POST['edit_id_rekap_penjualan']) && isset($_POST['edit_id_invoice']) && isset($_POST['edit_volume']) && isset($_POST['edit_quantity']) && isset($_POST['edit_total_penjualan'])) {
  ...
  $query = "UPDATE rekap_penjualan SET id_invoice='$idInvoice', volume='$volume', quantity='$quantity', total_penjualan='$totalPenjualan' WHERE id_rekap_penjualan='$idRekapPenjualan'";
  $result = mysqli_query($conn, $query);
