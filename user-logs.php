...
<body id="page-top">
                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <?php
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<a href='generate_pdf.php?tanggal_login=".htmlspecialchars($data['tanggal_login'])."' class='btn btn-primary btn-sm' target='_blank' role='button'><i class='fas fa-print'></i></a>";
                        echo "</td>";
                        echo "</tr>"; 
                    }
                  ?>
  ...
  <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
  <script>
    function openEditModal(tanggalLogin, posisi, username, namaLengkap, keterangan) {
      document.getElementById("edit_tanggal_login").value = tanggalLogin;
