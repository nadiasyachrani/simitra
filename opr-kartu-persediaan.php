...
if (isset($_POST['id_kartu_persediaan']) && isset($_POST['id_persediaan']) && isset($_POST['nama_persediaan']) && isset($_POST['tanggal_input']) && isset($_POST['harga_masuk']) && isset($_POST['jumlah_masuk']) && isset($_POST['total_masuk']) && isset($_POST['harga_keluar']) && isset($_POST['jumlah_keluar']) && isset($_POST['total_keluar']) && isset($_POST['harga_saldo']) && isset($_POST['jumlah_saldo']) && isset($_POST['total_saldo'])) {
  ...
  $query = "INSERT INTO kartu_persediaan (id_kartu_persediaan, id_persediaan, nama_persediaan, tanggal_input, harga_masuk, jumlah_masuk, total_masuk, harga_keluar, jumlah_keluar, total_keluar, harga_saldo, jumlah_saldo, total_saldo) VALUES ('$idKartuPersediaan', '$idPersediaan', '$namaPersediaan', '$tanggalInput', '$hargaMasuk', '$jumlahMasuk', '$totalMasuk', '$hargaKeluar', '$jumlahKeluar', '$totalKeluar', '$hargaSaldo', '$jumlahSaldo', '$totalSaldo')";
...
if (isset($_POST['edit_id_kartu_persediaan']) && isset($_POST['edit_id_persediaan']) && isset($_POST['edit_nama_persediaan']) && isset($_POST['edit_tanggal_input']) && isset($_POST['edit_harga_masuk']) && isset($_POST['edit_jumlah_masuk']) && isset($_POST['edit_total_masuk']) && isset($_POST['edit_harga_keluar']) && isset($_POST['edit_jumlah_keluar']) && isset($_POST['edit_total_keluar']) && isset($_POST['edit_harga_saldo']) && isset($_POST['edit_jumlah_saldo']) && isset($_POST['edit_total_saldo'])) {
  ...
  $query = "UPDATE kartu_persediaan SET id_persediaan='$idPersediaan', nama_persediaan='$namaPersediaan', tanggal_input='$tanggalInput', harga_masuk='$hargaMasuk', jumlah_masuk='$jumlahMasuk', total_masuk='$totalMasuk', harga_keluar='$hargaKeluar', jumlah_keluar='$jumlahKeluar', total_keluar='$totalKeluar', harga_saldo='$hargaSaldo', jumlah_saldo='$jumlahSaldo', total_saldo='$totalSaldo' WHERE id_persediaan='$idPersediaan'";
  $result = mysqli_query($conn, $query);
...
if (isset($_GET['id_kartu_persediaan'])) {
  $idKartuPersediaan = $_GET['id_kartu_persediaan'];

  $query = "DELETE FROM kartu_persediaan WHERE id_kartu_persediaan='$idKartuPersediaan'";
  $result = mysqli_query($conn, $query);
...
<body id="page-top">
                    ...
                    <div class="modal-body">
                        <form method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id_kartu_persediaan" name="id_kartu_persediaan" required>
                            </div>
                            <div class="mb-3">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST">
                            <div class="mb-3">
                                <label for="edit_id_kartu_persediaan" class="form-label">ID Kartu Persediaan:</label>
                                <input type="text" class="form-control" id="edit_id_kartu_persediaan" name="edit_id_kartu_persediaan" readonly required>
                            </div>
                            <div class="mb-3">
                ...
                <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td>".$data['id_kartu_persediaan']."</td>";
                        echo "<td>".$data['id_persediaan']."</td>";
                        echo "<td>".$data['nama_persediaan']."</td>";
                        echo "<td>".$data['tanggal_input']."</td>";
                        echo "<td>".number_format($data['harga_masuk'], 2, ',', '.')."</td>";
                        echo "<td>".number_format($data['jumlah_masuk'])."</td>";
                        echo "<td>".number_format($data['total_masuk'], 2, ',', '.')."</td>";
                        echo "<td>".number_format($data['harga_keluar'], 2, ',', '.')."</td>";
                        echo "<td>".number_format($data['jumlah_keluar'])."</td>";
                        echo "<td>".number_format($data['total_keluar'], 2, ',', '.')."</td>";
                        echo "<td>".number_format($data['harga_saldo'], 2, ',', '.')."</td>";
                        echo "<td>".number_format($data['jumlah_saldo'])."</td>";
                        echo "<td>".number_format($data['total_saldo'], 2, ',', '.')."</td>";    
                        echo "<td>";
                        echo "<button type='button' class='btn btn-success btn-sm' style='width: 30px; height: 30px;' data-bs-toggle='modal' data-bs-target='#editModal' onclick='openEditModal(\"".$data['id_kartu_persediaan']."\", \"".$data['id_persediaan']."\", \"".$data['nama_persediaan']."\", \"".$data['tanggal_input']."\", \"".$data['harga_masuk']."\", \"".$data['jumlah_masuk']."\", \"".$data['total_masuk']."\", \"".$data['harga_keluar']."\", \"".$data['jumlah_keluar']."\", \"".$data['total_keluar']."\", \"".$data['harga_saldo']."\", \"".$data['jumlah_saldo']."\", \"".$data['total_saldo']."\")'><i class='fas fa-edit'></i></button>";
                        echo "<button type='button' class='btn btn-danger btn-sm' style='width: 30px; height: 30px;' onclick='openDeleteModal(\"".$data['id_kartu_persediaan']."\")'><i class='fas fa-trash'></i></button>";
                        echo "</td>";
                        echo "</tr>"; 
                    }
                    ?>
  ...
  <!-- AWAL EDIT SESUAIKAN TABEL DATABASE -->
  <script>
    function openEditModal(idKartuPersediaan, idPersediaan, namaPersediaan, tanggalInput, hargaMasuk, jumlahMasuk, totalMasuk, hargaKeluar, jumlahKeluar, totalKeluar, hargaSaldo, jumlahSaldo, totalSaldo) {
        document.getElementById("edit_id_kartu_persediaan").value = idKartuPersediaan;
    ...
    function openDeleteModal(idKartuPersediaan) {
        ...
        document.getElementById('confirmDeleteBtn').onclick = function() {
            window.location.href = "?id_kartu_persediaan=" + idKartuPersediaan;
        };
    }
  </script>
  <!-- AKHIR EDIT SESUAIKAN TABEL DATABASE -->
