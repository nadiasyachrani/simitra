...
if (isset($_POST['id_customer']) && isset($_POST['nama_customer']) && isset($_POST['alamat_customer']) && isset($_POST['telp_customer']) && isset($_POST['email_customer']) && isset($_POST['pic']) && isset($_POST['phone_pic'])) {
  ...
  $emailCustomer = $_POST['email_customer'];
  $pic = $_POST['pic'];
  $phonePic = $_POST['phone_pic'];

  $query = "INSERT INTO data_customer (id_customer, nama_customer, alamat_customer, telp_customer, email_customer, pic, phone_pic) VALUES ('$idCustomer', '$namaCustomer', '$alamatCustomer', '$telpCustomer', '$emailCustomer', '$pic', '$phonePic')";
...
if (isset($_POST['edit_id_customer']) && isset($_POST['edit_nama_customer']) && isset($_POST['edit_alamat_customer']) && isset($_POST['edit_telp_customer']) && isset($_POST['edit_email_customer']) && isset($_POST['edit_pic']) && isset($_POST['edit_phone_pic'])) {
  ...
  $emailCustomer = $_POST['edit_email_customer'];
  $pic = $_POST['edit_pic'];
  $phonePic = $_POST['edit_phone_pic'];

  $query = "UPDATE data_customer SET nama_customer='$namaCustomer', alamat_customer='$alamatCustomer', telp_customer='$telpCustomer', email_customer='$emailCustomer', pic='$pic', phone_pic='$phonePic' WHERE id_customer='$idCustomer'";
  $result = mysqli_query($conn, $query);
...
if (isset($_GET['id_customer'])) {
  ...
  $query = "DELETE FROM data_customer WHERE id_customer='$idCustomer'";
  $result = mysqli_query($conn, $query);
...
// Mengambil data dari tabel data_customer
$query_select = "SELECT * FROM data_customer";
...
<head>
  ...
  <title>SIMITRA - Customer</title> <!-- EDIT NAMA -->
